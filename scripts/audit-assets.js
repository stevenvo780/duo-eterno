...
const ASSET_CATEGORIES = {
  GROUND: {
    cesped: [
      ...
      'tile_0210_suelo_cesped',
      'tile_0246_suelo_cesped',
      'tile_0278_suelo_cesped'
    ],
    tierra: [
      'tile_0144_suelo_tierra',
      'tile_0184_suelo_tierra',
      'tile_0216_suelo_tierra',
      'tile_0256_suelo_tierra'
    ],
    arena: [
      'tile_0143_suelo_arena',
      'tile_0179_suelo_arena',
      'tile_0219_suelo_arena',
      'tile_0243_suelo_arena'
    ],
    piedra: [
      'tile_0145_suelo_piedra',
      'tile_0181_suelo_piedra',
      'tile_0209_suelo_piedra',
      'tile_0221_suelo_piedra'
    ]
  },
  BUILDINGS: {
    ...
    comercial: [
      ...
      'tile_0007_edificio_comercial',
      'tile_0011_edificio_comercial'
    ],
    pequeño: [
      'tile_0004_edificio_pequeño',
      'tile_0008_edificio_pequeño',
      'tile_0012_edificio_pequeño'
    ],
  ...
  NATURE: {
    arbol_grande: [
      ...
      'tile_0032_arbol_grande',
      'tile_0036_arbol_grande',
      'tile_0160_arbol_grande'
    ],
    arbol_pequeño: [
      'tile_0033_arbol_pequeño',
      'tile_0069_arbol_pequeño',
      'tile_0161_arbol_pequeño',
      'tile_0173_arbol_pequeño'
    ],
    arbol_frondoso: [
      'tile_0034_arbol_frondoso',
      'tile_0070_arbol_frondoso',
      'tile_0146_arbol_frondoso',
      'tile_0162_arbol_frondoso'
    ],
    arbol_joven: [
      'tile_0035_arbol_joven',
      'tile_0071_arbol_joven',
      'tile_0107_arbol_joven',
      'tile_0147_arbol_joven'
    ]
  },
  ROADS: {
    horizontal: [
      'tile_0001_carretera_horizontal',
      'tile_0192_carretera_horizontal',
      'tile_0208_carretera_horizontal'
    ],
    vertical: [
      'tile_0189_carretera_vertical',
      'tile_0229_carretera_vertical',
      'tile_0245_carretera_vertical'
    ],
